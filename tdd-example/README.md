# Hello Numerical World TDD

This is an example of how to use TDD to add new functionality to a code. Please refer to the Testing module of the [BSSw Tutorial](https://bssw-tutorial.github.io) for details on how to use the code. 
